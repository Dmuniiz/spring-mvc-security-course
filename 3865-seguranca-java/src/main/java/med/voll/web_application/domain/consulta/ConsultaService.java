...
import med.voll.web_application.domain.pacientes.PacienteRepository;
...
public class ConsultaService {
    ...
    public ConsultaService(ConsultaRepository repository, PacienteRepository pacienteRepository, MedicoRepository medicoRepository) {
